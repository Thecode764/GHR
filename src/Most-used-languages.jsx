    ...
    return (
        <>
            <div className="flex justify-center items-center flex-col font-mono">
                <h2 className="font-mono mt-5 text-white flex gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-battery-full mt-1" viewBox="0 0 16 16">
  <path d="M2 6h10v4H2z"/>
