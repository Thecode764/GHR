    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center font-mono">
                <h1 className="text-white mt-5 flex gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pc mt-1" viewBox="0 0 16 16">
